<template>
    <div @click="handle" class="modal fade" id="viewachat" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
export default {
    ...
    methods : {
        handle()
        {
            ...
            var run = axios.post(this.link() + 'getpaymentachat',this.send,this.cors())
        run.then(e=>{
            this.view = e.data
        })
        run.catch(e=>{
