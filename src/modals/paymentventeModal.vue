<template>
    <div class="modal fade" id="paymentvente" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
export default {
    ...
    methods : {
        pay()
        {
            ...
            var run = axios.post(this.link() + 'paymentvente',this.send,this.cors())
            run.then(e=>{
                if(e.data == "yes")
                {
